...
t("home2.lede",
  "Builtly skaper en ny standard for rådgivende ingeniørtjenester. Vi forener ledende ingeniørkompetanse med egenutviklet software for å automatisere og effektivisere komplekse prosesser, forbedre kvalitet og transformere hvordan eiendomsprosjekter planlegges, prosjekteres og realiseres.",
  "Builtly is setting a new standard for consulting engineering. We unite leading engineering expertise with proprietary software to automate and streamline complex processes, improve quality and transform how real-estate projects are planned, designed and realised.")
